...
const Navbar: React.FC = () => {
    ...
    return (
        <>
            <nav className="lg:h-[90%] lg:w-24 max-lg:w-[90%] max-lg:h-20 bg-semi-dark-blue flex lg:flex-col items-center sm:m-8 lg:py-8 max-lg:px-4 sm:rounded-2xl max-sm:rounded-b-2xl lg:fixed max-lg:absolute z-50 max-sm:w-full max-sm:justify-center ">
                ...
                <div className="lg:w-5 lg:h-52 max-lg:h-5 max-lg:w-52 max-sm:w-36 lg:mt-20 max-lg:ml-10 max-sm:ml-0 flex lg:flex-col justify-between">
                    ...
                    <Link href={'/tv-series'}>
                        <svg width="20" height="20" className={`fill-greyish-blue hover:fill-red duration-300 cursor-pointer ${pathname === "/tv-series" ? 'fill-white hover:fill-white' : ''}`} xmlns="http://www.w3.org/2000/svg"><path d="M20 4.481H9.08l2.7-3.278L10.22 0 7 3.909 3.78.029 2.22 1.203l2.7 3.278H0V20h20V4.481Zm-8 13.58H2V6.42h10v11.64Zm5-3.88h-2v-1.94h2v1.94Zm0-3.88h-2V8.36h2v1.94Z" /></svg>
                    </Link>
