...
const UserIcon: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className={` absolute duration-500 ease-in-out transition-all bg-semi-dark-blue rounded-lg bottom-0 p-4 left-16 ${isCloudOpen ? 'w-40' : ' scale-0 -left-10 w-40'}`}>
